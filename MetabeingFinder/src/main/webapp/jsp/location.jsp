...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class='row'>
                <form method="POST" action="location/add" class="col-md-4 addForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="submit"  formmethod="POST" formaction="location/add" id="addLocation" class="btn btn-primary" value="Add Location" />
                    </div>
                </form>

                <div id='currentLocations' class='col-md-8 mainTable'>
                    <table id="location-table" class="table table-hover">
                        ...
                        <tbody id="content-rows">
                            ...
                            <c:forEach items="${locations}" var="l">
                                <tr>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/location/show/${l.locationId}">
                                            ${l.name}
                                        </a>
                                    </td>
                                    <td>
